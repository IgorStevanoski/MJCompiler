...
public class Matched_If_Statement extends Matched {

    private Condition condition;
    private Matched matched;
    private Matched matched1;

    public Matched_If_Statement (Condition condition, Matched matched, Matched matched1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("Matched_If_Statement(\n");
